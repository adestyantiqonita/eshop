...
class OrderTest {
    ...
    void testCreateOrderEmptyProducts() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            new Order("13652556-012a-4c07-b546-bc13f31eb35d", this.products, 1708560000L, "Bambang Sugeni");
        });
    }
    ...
    void testCreateOrderInvalidStatus() {
        assertThrows(IllegalArgumentException.class, () -> {
            new Order("13652556-012a-4c07-b546-bc13f31eb35d", this.products, 1708560000L, "Bambang Sugeni", "MEOW");
        });
    }
