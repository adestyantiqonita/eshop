...
class OrderServiceImplTest {
    ...
    void setUp() {
        ...
        Order order1 = new Order("13652556-012a-4c07-b546-bc13f31eb35d",
                products, 1708560000L, "Safira Sudrajat");
        this.orders.add(order1);

        Order order2 = new Order("7f9e15ad-687e-4a2f-9170-65924aa1f72d",
                products, 1708570000L, "Safira Sudrajat", OrderStatus.SUCCESS.getValue());
